...
//     const [warrantydays, setwarrantydays] = useState(1)
...
//                                                             <TextInput value={warrantydays} placeholder={'1'} style={{ padding: 0, paddingTop: rh(2), fontSize: siz * 0.02 }} />
//                                                         </View>
//                                                     </View>
//                                                 </View>
//                                                 :
...
//                                                 <Text>Number of Days</Text>
//                                                 <View style={{ borderBottomColor: Colors.yellow, borderBottomWidth: 1, }}>
//                                                     <TextInput value={warrantydays} placeholder={'0'} style={{ padding: 0, paddingTop: rh(2), fontSize: siz * 0.02 }} onChangeText={e => setwarrantydays(e)} />
//                                                 </View>
//                                             </View>
//                                         </View>
//                                         :
...
const AddProductStepthree = ({ navigation }) => {
    ...
    const nextscreen = () => {
        ...
        if (dateofpurchased === 'Select') {
            ...
            // if (dateofpurchased === moment(new Date()).format('D-M-YYYY')) {
                                            ...
                                            {allowexpirynotifications ?
                                                <View style={{ height: rh(29), width: rw(90) }}>
                                                    ...
                                                    <View style={{ height: rh(8), width: rw(30), marginTop: rh(5) }}>
                                                        <Text>Number of Days</Text>
                                                        <View style={{ borderBottomColor: Colors.yellow, borderBottomWidth: 1, }}>
                                                            <TextInput keyboardType='number-pad' value={warrantydays} placeholder={'1'} style={{ padding: 0, paddingTop: rh(2), fontSize: siz * 0.02 }} />
                                                        </View>
                                                    </View>
                                                </View>
                                                :
                                ...
                                <View style={{ flex: 1, }}>
                                    ...
                                    {allowexpirynotifications ?
                                        <View style={{ height: rh(29), width: rw(90) }}>
                                            ...
                                            <View style={{ height: rh(8), width: rw(30), marginTop: rh(5) }}>
                                                <Text>Number of Day</Text>
                                                <View style={{ borderBottomColor: Colors.yellow, borderBottomWidth: 1, }}>
                                                    <TextInput  keyboardAppearance='number-pad' value={warrantydays} placeholder={'0'} style={{ padding: 0, paddingTop: rh(2), fontSize: siz * 0.02 }} onChangeText={e => setwarrantydays(e)} />
                                                </View>
                                            </View>
                                        </View>
